...
const TableNameCrmUserV2 = "crm_userv2"

// CrmUser Account
type CrmUserV2 struct {
	UserID           int32  `gorm:"column:user_id;primaryKey;autoIncrement:true;comment:Account ID" json:"user_id"` // Account ID
	UsrEmail         string `gorm:"column:usr_email;not null;type:varchar(255);comment:Email" json:"usr_email"`
	UsrPassword      string `gorm:"column:usr_password;not null;comment:Password" json:"usr_password"`                         // Password
	UsrUsername      string `gorm:"column:usr_username;not null;type:varchar(255);comment:Username" json:"usr_username"`                         // Username
	UsrPhone         string `gorm:"column:usr_phone;not null;type:varchar(255);comment:Phone Number" json:"usr_phone"`                           // Phone Number
...
func (*CrmUserV2) TableName() string {
